	...
	public static void main(String[] args) 
	{
		...
		while (exerciseNo != 0)
		{
			try 
			{
				...
				case 1:
				{
					String createTable = "CREATE TABLE EmployeeDetails (EMPLOYEE_ID INT AUTO_INCREMENT, NAME VARCHAR(45) NOT NULL, MOBILE BIGINT NOT NULL UNIQUE, EMAIL VARCHAR(45) NOT NULL UNIQUE, DEPARTMENT VARCHAR(45) NOT NULL, PRIMARY KEY (EMPLOYEE_ID))";
					run.createTable(createTable);
					break;
				}
				...
				case 4:
				{
					...
					case 1:
						...
						get.scan.nextLine();
						String department = get.scan.nextLine();
						run.modifyAnyColumnDetails(id, "DEPARTMENT", department);
						break;
						
					case 2:
						System.out.println("Enter New Mobile: ");
						String mobile = get.scan.next();
						run.modifyAnyColumnDetails(id, "MOBILE", mobile);
						break;
						
					case 3:
						System.out.println("Enter New Email: ");
						String email = get.scan.next();
						run.modifyAnyColumnDetails(id, "EMAIL", email);
						break;
...
//					System.out.println("In which order the name will print: ");
				...
				case 9:
				{
					String createTable = "CREATE TABLE EmployeeFamilyDetails (EMPLOYEE_ID INT, NAME VARCHAR(45) NOT NULL, AGE INT NOT NULL, RELATIONSHIP VARCHAR(45) NOT NULL, FOREIGN KEY (EMPLOYEE_ID) REFERENCES EmployeeDetails (EMPLOYEE_ID))";
					run.createTable(createTable);
					break;
				}
