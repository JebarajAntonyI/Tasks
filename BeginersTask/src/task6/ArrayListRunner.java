		...
		while (exerciseNo != 0)
		{
			try
			{
				...
				case 5:
				{
					...
					inputAL = run.getArrayListOfIntAndString(number, intArr, number2, stringArr2);
					inputAL.add(get);
					inputAL.add(run);
					get.printArrayList(inputAL);
					System.out.println();
				...
				case 6:
				{
					...
					int position = run.findPosition(inputAL,find);
				...
				case 9:
				{
					...
					int firstIndex = run.findPosition(inputAL, word);
				...
				case 13:
				{
					...
					inputAL2 = run.getArrayListOfStrings(number, inputStringArr2);
					List<String> inputAL3 = new ArrayList<>();
					inputAL3 = run.mergeTwoArrayListSecondAndFirst(inputAL1, inputAL2);
					size = run.getSizeOfArrayList(inputAL3);
					System.out.println("The size of Array List: " + size);
					get.printArrayList(inputAL3);
					break;
