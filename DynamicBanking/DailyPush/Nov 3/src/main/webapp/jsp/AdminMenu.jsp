...
<body>
	...
	<form action="<%= request.getContextPath() %>/servlet" target="adminArea">
		...
		<div><button type="submit" value="userDetails" name="action">Search User</button></div>
		<div><button type="submit" value="accountDetails" name="action">Search Account</button></div>
