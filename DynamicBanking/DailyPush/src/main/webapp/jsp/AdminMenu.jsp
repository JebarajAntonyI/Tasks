...
<body>
	...
	<form action="<%= request.getContextPath() %>/servlet" target="adminArea">
		...
		<div><button type="submit" value="searchUser" name="action">Search User</button></div>
		<div><button type="submit" value="AdminaccountDetails" name="action">Search Account</button></div>
