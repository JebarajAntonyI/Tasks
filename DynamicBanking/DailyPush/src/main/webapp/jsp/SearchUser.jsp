...
<p><input type="number" name="id" placeholder="Enter User Id" required></p>
	<button type = "submit" name="action" value="userDetails">User Details</button>
	<button type = "submit" name="action" value="accountDetails">Account Details</button>
	<button type = "submit" name="action" value="Transaction Details">Transaction Details</button>
</form>
